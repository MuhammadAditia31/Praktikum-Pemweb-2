...
class Pasien
{
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            // Hapus data terkait di tabel 'periksa' yang mengacu pada pasien_id
            $sql = "DELETE FROM periksa WHERE pasien_id = :id";
            $stmt = $this->pdo->prepare($sql);
            $stmt->bindParam(':id', $id);
            $stmt->execute();
            ...
            // Mengembalikan data pasien yang telah dihapus
            return $row;
